...
>
        <div className="self-stretch flex flex-row items-start justify-start [row-gap:30px] max-w-full mq1350:flex-wrap">
          ...
          <img
            className="h-[811px] flex-1 relative max-w-full overflow-hidden object-cover min-w-[568px] z-[1] mq800:min-w-full"
            alt=""
            src="/presently--macbook@2x.png"
          />
        </div>
        <div className="w-[1362px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-26xl">
