...
const MacBookPro16 = () => {
  ...
  return (
    <div className="w-full relative bg-brand-neutrals overflow-hidden flex flex-col items-end justify-start pt-0 px-0 pb-[198px] box-border gap-[146px] leading-[normal] tracking-[normal] mq1125:gap-[73px] mq450:gap-[36px]">
      ...
      <img
        className="w-[799px] relative max-h-full object-cover hidden max-w-full z-[1]"
        loading="lazy"
        alt=""
        src="/image-3@2x.png"
      />
      <img
        className="w-[100px] h-[100px] absolute !m-[0] bottom-[1183px] left-[804px] overflow-hidden shrink-0 cursor-pointer z-[1]"
        loading="lazy"
        alt=""
